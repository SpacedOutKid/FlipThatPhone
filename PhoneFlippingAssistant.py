...
class AverageSalePrice():
   ...
   #iPhone X Average Sale Prices 
    ...
    _iPhone11ProMaxL256GbAverage = usedIphoneSheet['C108'].value #Cell position for an average price of a 256Gb unlocked iPhone 11 Pro Max
    _iPhone11ProMaxL512GbAverage = usedIphoneSheet['C109'].value #Cell position for an average price of a 512Gb unlocked iPhone 11 pro Max 
...
class CellPositions():
   ...
   _iPhoneXSMaxUL512GbDLow = usedIphoneSheet['K78'].value #Cell position for D Grade High of a locked iPhone XS Max 512Gb
   _iPhoneXSMaxL64GbAHigh = usedIphoneSheet['D79'].value #Cell position for A Grade High of a locked iPhone XS Max 64Gb
   _iPhoneXSMaxL64GbALow = usedIphoneSheet['E79'].value #Cell position for A Grade Low of a locked iPhone XS Max 64Gb
   ...
   #
   _iPhone11ProUL64GbAHigh = usedIphoneSheet['D95'].value #Cell position for A Grade High of a unlocked iPhone 11 Pro 64Gb
   _iPhone11ProUL64GbALow = usedIphoneSheet['E95'].value #Cell position for A Grade Low of a unlocked iPhone 11 Pro 64Gb
   ...
   _iPhone11ProUL512GbBLow = usedIphoneSheet['G97'].value #Cell position for B Grade Low of a unlocked iPhone 11 Pro 512Gb
   ...
   #
   _iPhone11ProMaxUL64GbAHigh = usedIphoneSheet['D104'].value #Cell position for A Grade High of a unlocked iPhone 11 Pro Max 64Gb
   _iPhone11ProMaxUL64GbALow = usedIphoneSheet['E104'].value #Cell position for A Grade Low of a unlocked iPhone 11 Pro Max 64Gb
   ...
   _iPhone11ProMaxUL512GbBLow = usedIphoneSheet['G106'].value #Cell position for B Grade Low of a unlocked iPhone 11 Pro Max 512Gb
...
#iPhone XS Max Option
        ...
        while phonePrice == False: #loop so the user can continue with the phone without resetting program
            MenuBorder.border('*')
            print('\t\t 🗄 Storage Sizes🗄 :\n')
            for key, value in StorageSizes._iPhoneXSMaxStorage.items():
                print('\t\t   ', key, ':', value)
            MenuBorder.border('*')
            storageOption = eval(input('\nEnter the number of the storage size of the iPhone: '))
            #iPhone XS Max 64GB Option
            if storageOption == 1: 
                MenuBorder.border('*') 
                print('\t\t 📡 Carrier Options 📡:\n') #Displays the carrier options for the user to select if it is unlocked or locked 
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone XS Max 64GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS Max, 64GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max Unlocked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxUL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxUL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS Max, 64Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max Unlocked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxUL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxUL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS Max, 64Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxUL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxUL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS Max, 64Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxUL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxUL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone XS Max 64GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS, Max 64GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max locked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 64Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max locked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 64Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 64Gb locked D Grade  Option    
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone XS Max 256Gb Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone XS Max 256GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS, Max 256GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max Unlocked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxUL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxUL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max Unlocked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxUL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxUL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxUL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxUL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxUL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxUL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone XS Max 256GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS, Max 256GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max locked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max locked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 256Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone XS Max 512GB Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone XS Max 512GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS, Max 512GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max Unlocked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxUL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxUL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max Unlocked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxUL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxUL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxUL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxUL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max Unlocked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxUL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxUL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxUL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone XS Max 512GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone XS, Max 512GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone XS Max locked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhoneXSMaxL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhoneXSMaxL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone XS Max locked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhoneXSMaxL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhoneXSMaxL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhoneXSMaxL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhoneXSMaxL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone XS, Max 512Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone XS Max locked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhoneXSMaxL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhoneXSMaxL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhoneXSMaxL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
    ...
    #iPhone 11 Option
        ...
        while phonePrice == False: #loop so the user can continue with the phone without resetting program
            MenuBorder.border('*')
            print('\t\t 🗄 Storage Sizes🗄 :\n')
            for key, value in StorageSizes._iPhone11Storage.items():
                print('\t\t   ', key, ':', value)
            MenuBorder.border('*')
            storageOption = eval(input('\nEnter the number of the storage size of the iPhone: '))
            #iPhone 11 64GB Option
            if storageOption == 1: 
                MenuBorder.border('*') 
                print('\t\t 📡 Carrier Options 📡:\n') #Displays the carrier options for the user to select if it is unlocked or locked 
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 64GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 64GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Unlocked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11UL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11UL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Unlocked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11UL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11UL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11UL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11UL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11UL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11UL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                ...
                #iPhone 11 64GB Locked Option
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 64GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 locked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11L64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11L64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 locked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11L64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11L64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11L64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11L64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 64Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11L64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11L64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone 11 128Gb Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 128GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 128GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Unlocked 128GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL128GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11UL128GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11UL128GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Unlocked 128GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL128GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11UL128GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11UL128GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 128GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL128GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11UL128GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11UL128GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 128GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL128GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11UL128GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11UL128GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                ...
                #iPhone 11 128GB Locked Option
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 128GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 locked 128GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L128GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11L128GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11L128GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 locked 128GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L128GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11L128GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11L128GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 128GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L128GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11L128GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11L128GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 128Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 128GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L128GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11L128GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11L128GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone 11 256GB Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 256GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 256GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Unlocked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11UL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11UL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Unlocked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11UL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11UL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11UL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11UL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Unlocked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11UL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11UL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11UL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                ...
                #iPhone 11 256GB Locked Option
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11, 256GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 locked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11L256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11L256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 locked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11L256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11L256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11L256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11L256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11, 256Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 locked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11L256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11L256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11L256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
    ...
    #iPhone 11 Pro Option
        ...
        while phonePrice == False: #loop so the user can continue with the phone without resetting program
            MenuBorder.border('*')
            print('\t\t 🗄 Storage Sizes🗄 :\n')
            for key, value in StorageSizes._iPhone11ProStorage.items():
                print('\t\t   ', key, ':', value)
            MenuBorder.border('*')
            storageOption = eval(input('\nEnter the number of the storage size of the iPhone: '))
            #iPhone 11 Pro 64GB Option
            if storageOption == 1: 
                MenuBorder.border('*') 
                print('\t\t 📡 Carrier Options 📡:\n') #Displays the carrier options for the user to select if it is unlocked or locked 
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro 64GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 64GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Unlocked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProUL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProUL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Unlocked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProUL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProUL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProUL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProUL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProUL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProUL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro 64GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 64GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro locked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro locked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 64Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone 11 Pro 256Gb Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro 256GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 256GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Unlocked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProUL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProUL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Unlocked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProUL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProUL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProUL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProUL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProUL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProUL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro 128GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 256GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro locked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro locked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 256Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
            ...
            #iPhone 11 Pro 512GB Option
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro 512GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 512GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Unlocked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProUL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProUL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Unlocked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProUL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProUL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProUL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProUL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Unlocked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProUL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProUL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProUL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro 512GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, 512GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro locked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro locked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, 512Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro locked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
        ...
        while phonePrice == False: #loop so the user can continue with the phone without resetting program
            ...
            if storageOption == 1: 
                ...
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro Max 64GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro Max 64GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max Unlocked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxUL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxUL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, Max 64Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max Unlocked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxUL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxUL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, Max 64Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxUL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxUL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro, Max 64Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxUL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxUL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro Max 64GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro Max 64GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max locked 64GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL64GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxL64GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxL64GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 64Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max locked 64GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL64GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxL64GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxL64GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 64Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 64GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL64GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxL64GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxL64GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 64Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 64GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL64GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxL64GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxL64GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
            #iPhone 11 Pro Max 256Gb Option
            elif storageOption == 2: 
                MenuBorder.border('*') 
                print('\t\t 📡 Carrier Options 📡:\n') #Displays the carrier options for the user to select if it is unlocked or locked 
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro Max 256GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro Max 256GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max Unlocked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxUL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxUL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max Unlocked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxUL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxUL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxUL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxUL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxUL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxUL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro Max 128GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro Max 256GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max locked 256GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL256GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxL256GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxL256GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max locked 256GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL256GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxL256GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxL256GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 256GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL256GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxL256GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxL256GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 256Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 256GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL256GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxL256GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxL256GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
            #iPhone 11 Pro Max 512GB Option
            elif storageOption == 3:
                MenuBorder.border('*') 
                print('\t\t 📡 Carrier Options 📡:\n') #Displays the carrier options for the user to select if it is unlocked or locked 
                for key, value in carrier.items(): #prints the carrier options in the dict
                    print('\t\t   ', key, ':', value)
                MenuBorder.border('*')
                #iPhone 11 Pro Max 512GB Unlocked Option
                carrierOption = eval(input('\nEnter the number cooresponding to if the phone is carrier unlocked or locked: ')) #user selecets carrier option
                if carrierOption ==1: #carrier unlocked options
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro, Max 512GB Unlocked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max Unlocked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxUL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxUL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb Unlocked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max Unlocked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxUL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxUL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb Unlocked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxUL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxUL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb Unlocked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max Unlocked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxUL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxUL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxUL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                #iPhone 11 Pro Max 512GB Locked Option
                elif carrierOption == 2: 
                    MenuBorder.border('*') 
                    print('\t\t  🔧Grade Options🔧:\n') #displays the grading option title
                    for key, value in gradeOptions.items():#displays the grading options for the user to select
                    ...
                    MenuBorder.border('*')
                    phoneCondition = eval(input('Enter the number for the condition of the phone based on the grading scale: '))
                    #iPhone 11 Pro Max  512GB locked A Grade Option
                    if phoneCondition == 1:
                        MoneyBorder.border('self')
                        print('\n')
                        print('\t   📱iPhone 11 Pro Max locked 512GB A Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL512GbAverage:,.2f}')
                        print(f'\t      A Grade High: ${CellPositions._iPhone11ProMaxL512GbAHigh:,.2f}')
                        print(f'\t      A Grade Low: ${CellPositions._iPhone11ProMaxL512GbALow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('You entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb locked B Grade  Option      
                    elif phoneCondition == 2:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t     📱iPhone 11 Pro Max locked 512GB B Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL512GbAverage:,.2f}')
                        print(f'\t      B Grade High: ${CellPositions._iPhone11ProMaxL512GbBHigh:,.2f}')
                        print(f'\t      B Grade Low: ${CellPositions._iPhone11ProMaxL512GbBLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb locked C Grade  Option      
                    elif phoneCondition == 3:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 512GB C Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL512GbAverage:,.2f}')
                        print(f'\t      C Grade High: ${CellPositions._iPhone11ProMaxL512GbCHigh:,.2f}')
                        print(f'\t      C Grade Low: ${CellPositions._iPhone11ProMaxL512GbCLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
                            ...
                            print('\nYou entered an invalid charachter')
                            choice = input('\nWould you like to try different options for this phone? Enter a Y for yes or an N for no: ').upper()
                    #iPhone 11 Pro Max 512Gb locked D Grade  Option      
                    elif phoneCondition == 4:
                        MoneyBorder.border('self') #Border from the Money Border class
                        print('\n')
                        print('\t    📱iPhone 11 Pro Max locked 512GB D Grade📱')
                        print(f'\t\t\n              Average Sales Price: ${AverageSalePrice._iPhone11ProMaxL512GbAverage:,.2f}')
                        print(f'\t      D Grade High: ${CellPositions._iPhone11ProMaxL512GbDHigh:,.2f}')
                        print(f'\t      D Grade Low: ${CellPositions._iPhone11ProMaxL512GbDLow:,.2f}')
                        MoneyBorder.border('self')
                        print('\n')
                        choice = input('\nWould you like to try differnt options for this phone? Enter a Y for yes or an N for no: ').upper() #Option to see if the user would like to continue 
                        if choice == 'Y': 
